...
-- ===========================================================================
-- MERCADO: descoberta de outros usuarios e seus albuns em SOMENTE LEITURA.
-- RPCs SECURITY DEFINER que NUNCA expoem e-mail/telefone/metadados pessoais.
-- O identificador publico do usuario sao os 8 primeiros caracteres do UUID
-- (derivados no frontend). Ver migration 20260531_mercado.sql e ADR-003.
-- ===========================================================================
